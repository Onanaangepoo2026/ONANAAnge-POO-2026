...
public class VLAN {
    ...
    private ResultatVLSM reseauAssocie;     private String description; 
 
    public VLAN(int id, String nom, ResultatVLSM reseauAssocie, String 
description) {         setId(id);         setNom(nom); 
        this.reseauAssocie = reseauAssocie;         setDescription(description); 
    } 

    VLAN(int numeroVLAN, String nomBesoin, ResutatVLSM res, String string) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    public int getId() {         return id; 
    } 
    public void setId(int id) {         if (id < 1 || id > 4094) { 
            this.id = 1; 
        } else { 
            this.id = id; 
        } 
    ...
    public void afficher() { 
        ...
        if (reseauAssocie != null) {             reseauAssocie.afficher(); 
        } 
    } 
